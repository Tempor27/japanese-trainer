...
# use mysql database instead of list for vocab

# change source member to a list so vocab can be included in multiple packs
...
vocab_list = [Word("noun", "person", "family", "father", "おとうさん", "101", ["unit 1"], "お父さん"),
              ...
              Word("noun", "person", "family", "wife", "おくさん", "102", ["bonus 1", "unit 14"], "奥さん"),
              ...
              Word("noun", "person", "family", "husband", "こしゅじん", "102", ["unit 14"], "こ主人"),
              Word("noun", "person", "family", "partner", "パートナー", "102", ["unit 14"]),
              Word("noun", "person", "family", "uncle", "おじさん", "102", ["unit 14"]),
              Word("noun", "person", "family", "aunt", "おばさん", "102", ["unit 14"]),
              Word("noun", "person", "family", "parents", "りょうしん", "102", ["unit 14"], "両親"),
              ...
              Word("noun", "person", "occupation", "landlord", "おおやさん", "102", ["unit 14"], "大家さん"),
              ...
              Word("noun", "person", "other", "everyone", "みなさん", "102", ["unit 14"], "皆さん"),
              Word("noun", "person", "other", "foreigner", "がいこくじん", "102", ["unit 15"], "外国人"),
              Word("noun", "person", "other", "volunteer", "ボランティア", "102", ["unit 15"]),
              ...
              Word("noun", "place", "other", "classroom", "きょうしつ", "102", ["unit 15"], "教室"),
              Word("noun", "place", "other", "building", "たてもの", "102", ["unit 15"], "建物"),
              Word("noun", "place", "other", "swimming pool", "プール", "102", ["unit 15"]),
              Word("noun", "place", "other", "movie theater", "えいがかん", "102", ["unit 15"], "映画館"),
              Word("noun", "place", "other", "japanese inn", "りょかん", "102", ["unit 15"], "旅館"),
              Word("noun", "place", "other", "garden", "にわ", "102", ["unit 15"], "庭"),
              ...
              Word("noun", "thing", "clothes", "sweatshirt", "トレーナー", "102", ["unit 14"]),
              Word("noun", "thing", "clothes", "shirt", "シャツ", "102", ["unit 14"]),
              Word("noun", "thing", "clothes", "necktie", "ネクタイ", "102", ["unit 14"]),
              Word("noun", "thing", "clothes", "winter scarf", "マフラー", "102", ["unit 14"]),
              Word("noun", "thing", "clothes", "ring", "ゆびわ", "102", ["unit 14"], "指輪"),
              ...
              Word("noun", "thing", "technology", "radio", "ラジオ", "102", ["unit 14"]),
              ...
              Word("noun", "thing", "food", "chocolate", "チョコレート", "102", ["unit 14"]),
              Word("noun", "thing", "food", "strawberry", "いちご", "102", ["bonus 1"]),
              Word("noun", "thing", "food", "watermelon", "すいか", "102", ["bonus 1"]),
              Word("noun", "thing", "food", "mandarin orange", "みかん", "102", ["bonus 1", "unit 14"]),
              ...
              Word("noun", "thing", "time", "Christmas", "クリスマス", "102", ["unit 14"]),
              Word("noun", "thing", "time", "Valentine's Day", "バレンタインデー", "102", ["unit 14"]),
              Word("noun", "thing", "time", "White Day", "ホワイトデー", "102", ["unit 14"]),
              ...
              Word("noun", "thing", "other", "pencil", "えんぴつ", "102", ["unit 14", "bonus 1"], "鉛筆"),
              Word("noun", "thing", "other", "stuffed animal", "めいぐるみ", "102", ["unit 14"]),
              Word("noun", "thing", "other", "comic book", "まんが", "102", ["unit 14"], "漫画"),
              Word("noun", "thing", "other", "cosmetics", "けしょうひん", "102", ["unit 14"], "化粧品"),
              Word("noun", "thing", "other", "plate", "おさら", "102", ["unit 14"], "お皿"),
              Word("noun", "thing", "other", "a return (token of gratitude)", "おかえし", "102", ["unit 14"], "お返し"),
              Word("noun", "thing", "other", "resume", "やくそく", "102", ["unit 14"], "約束"),
              ...
              Word("pronoun", "", "", "we", "わたしたち", "101", ["unit 14"], "私たち"),

              Word("title", "", "", "Mr./Ms.", "さん", "101", ["unit 1"]),
              Word("title", "", "", "Mr./Ms. (casual)", "くん", "101", ["unit 14"]),
              ...
              Word("adjective", "i", "", "to want", "ほしい", "102", ["unit 14"], "欲しい"),
              ...
              Word("adjective", "na", "", "fashionable", "おしゃれな", "102", ["unit 14"]),
              Word("adjective", "na", "", "stingy/cheap", "けちな", "102", ["unit 14"]),
              ...
              Word("question", "", "", "what should one do", "どうしたらいい", "102", ["unit 14"]),
              ...
              Word("verb", "u", "り", "to send", "おくる", "102", ["unit 14"], "送る"),
              Word("verb", "u", "り", "to look good (on somebody)", "にあう", "102", ["unit 14"], "似合う"),
              ...
              Word("verb", "ru", "", "to give up", "あきらめる", "102", ["unit 14"]),
              Word("verb", "ru", "", "to give (others)", "あげる", "102", ["unit 14"]),
              Word("verb", "ru", "", "to give (me)", "くれる", "102", ["unit 14"]),
              Word("verb", "ru", "", "to be made", "できる", "102", ["unit 14"]),
              ...
              Word("verb", "irregular", "する", "to consult", "そうだんする", "102", ["unit 14"], "相談する"),
              Word("verb", "irregular", "する", "to give warning", "ちゅういする", "102", ["unit 14"], "注意する"),
              Word("verb", "irregular", "する", "to propose marriage", "プロポーズする", "102", ["unit 14"]),
              ...
              Word("expressions", "", "", "s (plural)", "たち", "102", ["unit 14"]),
              Word("expressions", "", "", "this kind of", "こんな", "102", ["unit 14"]),
              Word("expressions", "", "", "suddenly", "きゅうに", "102", ["unit 14"], "急に"),
              Word("expressions", "", "", "exactly", "ちょうど", "102", ["unit 14"]),
              Word("expressions", "", "", "well", "よく", "102", ["unit 14"]),
              Word("expressions", "", "", "I'm not sure", "さあ", "102", ["unit 14"]),
...
counter_list = [Counter("ドル", "dollars", "1", ""),
                ...
                Counter("だい", "vehicles/electronics", "1", "台"),
